...
export const processCommand = (
    ...
    if (baseCmd === "vim") {
        ...
        if (isProtected) {
            return { 
                output: <span className="text-red-500">bash: vim: {rawTarget}: Permission denied</span> 
            };
        }
        ...
        if (VFS[absolutePath] && VFS[absolutePath].type === "dir") {
            return {
                output: <span className="text-red-500">bash: vim {rawTarget}  Permission denied trying to edit directory files.</span>
            };
        }

        return { 
            output: "", systemAction: "VIM", meta: { vimFile: rawTarget } 
        };
    }
        ...
        output: (
            <div className="text-red-500">
                ...
                <p className="text-white/50 text-xs mt-1">
                    Type <span className="text-yellow-400 underline cursor-pointer">help</span> for a list of available protocols.
                </p>
            </div>
        )
    };
