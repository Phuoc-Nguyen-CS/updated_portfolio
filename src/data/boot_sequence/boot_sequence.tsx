...
export const BOOT_SEQUENCE: BootLog[] = [
  {
    text: " [ SYSTEM_BOOTUP_SEQUENCE ] ",
    delay: 600,
    color: "text-hacker-green underline opacity-80 tracking-widest",
  },
  {
  ...
  },
  {
    text: "-------------------------------------------",
    delay: 100,
    color: "text-hacker-green/30",
  },
  {
    text: " >> SESSION_ESTABLISHED: GUEST",
    delay: 500,
    color: "text-hacker-green font-black animate-pulse tracking-tighter",
  },
