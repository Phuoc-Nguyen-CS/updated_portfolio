...
export const ResumeFile = () => (
    <div className="mt-4 space-y-10 md:space-y-14 text-base md:text-xl max-w-5xl font-mono leading-relaxed antialiased">
        ...
        <section>
            ...
            <div className="pl-4 md:pl-10 border-l-2 md:border-l-4 border-white/10 ml-1 mt-6">
                ...
                <div>
                    ...
                    <div className="bg-black/40 border border-white/5 p-4">
                        <div className="grid grid-cols-3 gap-2">
                            <div className="text-center py-2 bg-white/5"><p className="text-[8px] text-green-500 font-bold uppercase">Easy</p><p className="text-base md:text-2xl text-white font-black">17</p></div>
                            <div className="text-center py-2 bg-white/5"><p className="text-[8px] text-yellow-500 font-bold uppercase">Med</p><p className="text-base md:text-2xl text-white font-black">43</p></div>
                            <div className="text-center py-2 bg-white/5"><p className="text-[8px] text-red-500 font-bold uppercase">Hard</p><p className="text-base md:text-2xl text-white font-black">11</p></div>
                        </div>
                    </div>
                </div>
            </div>
        </section>
        <div className="pt-8 opacity-20 text-center border-t-2 border-white/5 text-[10px] md:text-sm font-black tracking-[1em] uppercase">--- END OF TRANSMISSION ---</div>
    </div>
);