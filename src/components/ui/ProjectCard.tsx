...
export const ProjectCard = ({ project }: { project: Project }) => (
    <div className="group bg-white/5 p-4 md:p-8 border border-white/10 rounded-sm hover:border-blue-500/50 transition-all duration-300 flex flex-col">
        <div className="flex flex-col mb-2">
            <p className="text-white font-black mb-1 uppercase text-xs md:text-base tracking-widest">
                {project.title}
            </p>
            <p className="text-[9px] md:text-xs text-blue-400 font-bold">
                {project.tech}
            </p>
        </div>
